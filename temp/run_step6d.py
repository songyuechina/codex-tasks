...
print('[STEP] Step6d: cad_zt_zero -> oneb -> open file')
cad_zt_zero()
cad_zt_oneb()
open_file(TARGET)
li()
print('[STEP] Step6d: insert door at (0, 1200, 0)')
insert_tarch_door((0,1200,0), width=200, height=3000)
print('[STEP] Step6d: save & close -> cad_zt_zero')
save_file()
close_file(save_option="prompt")
cad_zt_zero()
print('[DONE] Step6d complete')
